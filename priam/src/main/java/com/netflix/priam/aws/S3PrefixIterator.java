...
/**
 * Class to iterate over prefixes (S3 Common prefixes) upto the token element in the path. The
 * abstract path generated by this class is partial (does not have all data).
 */
