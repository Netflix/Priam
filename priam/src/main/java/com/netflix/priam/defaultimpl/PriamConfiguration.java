...
public class PriamConfiguration implements IConfiguration
{
    ...
    private static final String CONFIG_RESTORE_SOURCE_TYPE = PRIAM_PRE + ".restore.source.type"; //the type of source for the restore.  Valid values are: AWSCROSSACCTENCRYPTED or GOOGLE.
    ...
    private static final String CONFIG_PGP_PUB_KEY = PRIAM_PRE + ".pgp.pubkey.file.location"; //public key used by the cryptography algorithm
  ...
  @Override
   ...
   public String getInternodeEncryption()
	...
	public String getPgpPublicKey() {
		return config.get(CONFIG_PGP_PUB_KEY);
	}    
