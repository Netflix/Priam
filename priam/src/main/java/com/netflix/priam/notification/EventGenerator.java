...
/**
 * Generic interface which a event generator class should implement so all the observers could be notified of the events.
...
public interface EventGenerator<T> {
    /**
     * Subscribe yourself to receive generation/change of events.
     *
     * @param observer {@link EventObserver} interested in receiving updates from generator.
     */
    void addObserver(EventObserver<T> observer);

    /**
     * Remove yourself from receiving any further events from this generator.
     *
     * @param observer {@link EventObserver} who subscribed to receive events from generator before.
     */
