...
public class BackupServletTest {
    ...
    public void restore_minimal(
        ...
        Response response =
                restoreResource.restore(dateRange, newRegion, newToken, keyspaces, null);
        assertEquals(200, response.getStatus());
        assertEquals("[\"ok\"]", response.getEntity());
        assertEquals(
                MediaType.APPLICATION_JSON_TYPE, response.getMetadata().get("Content-Type").get(0));
    ...
    @Test
    public void restore_withDateRange(
            @Mocked final InstanceIdentity identity,
            @Mocked final PriamInstance instance,
            @Mocked final AbstractBackupPath backupPath)
            throws Exception {
    ...
    //                factory.getAllIds(appName); result = ImmutableList.of(instance, instance1,
    // instance2, instance3);
    ...
    @Test
    public void restore_withKeyspaces(
            @Mocked final InstanceIdentity identity, @Mocked final PriamInstance instance)
            throws Exception {
        final String dateRange = null;
        final String newRegion = null;
    ...
    public void restore_maximal(
        ...
        new Expectations() {

            {
                ...
                //
                //                instance.getToken(); result = oldToken;
                //                factory.getAllIds(appName); result = ImmutableList.of(instance,
                ...
                //                instance2.getToken(); result = "5678";
                //                instance3.getToken(); result = "9000";
                //                instance.setToken((String) any); // TODO: test mocked closest
                // token
