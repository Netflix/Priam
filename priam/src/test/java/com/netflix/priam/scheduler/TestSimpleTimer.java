...
public class TestSimpleTimer {
    ...
    public void negativePeriod() {
        assertIllegalArgument(() -> new SimpleTimer("foo", -PERIOD, START));
    }

    @Test
    public void zeroPeriod() {
        assertIllegalArgument(() -> new SimpleTimer("foo", 0, START));
    }
    ...
    private void assertIllegalArgument(Runnable method) {
        try {
            method.run();
