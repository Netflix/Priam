...
public class TestFileIterator
{
    ...
    public void testIteratorEmptySet()
    {
        ...
        MockAmazonS3Client.prefix = conf.getBackupLocation() + "/" + conf.getDC() + "/" + conf.getAppName() + "/" + factory.getInstance().getPayload();
    ...
    public void testRestorePathIteration()
    {
        ...
        MockAmazonS3Client.prefix = "test_restore_backup/fake-restore-region/fakerestorecluster" + "/" + factory.getInstance().getPayload();
        MockAmazonS3Client.prefix += "/20110811";
