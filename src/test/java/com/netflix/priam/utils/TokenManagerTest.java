...
public class TokenManagerTest
{
    ...
    public void test4Splits()
    {
        ...
        final String expectedTokens = "0,42535295865117307932921825928971026431,"
                + "85070591730234615865843651857942052863,127605887595351923798765477786913079295";
    ...
    {
        final String expectedTokens = "0,10633823966279326983230456482242756607,"
                + "21267647932558653966460912964485513215,31901471898837980949691369446728269823,"
                + "42535295865117307932921825928971026431,53169119831396634916152282411213783039,"
                + "63802943797675961899382738893456539647,74436767763955288882613195375699296255,"
                + "85070591730234615865843651857942052863,95704415696513942849074108340184809471,"
                + "106338239662793269832304564822427566079,116972063629072596815535021304670322687,"
                + "127605887595351923798765477786913079295,138239711561631250781995934269155835903,"
                + "148873535527910577765226390751398592511,159507359494189904748456847233641349119";
        String[] tokens = expectedTokens.split(",");
        int splits = tokens.length;
        for (int i = 0; i < splits; i++)
            assertEquals(new BigInteger(tokens[i]), TokenManager.initialToken(splits, i, 0));
