...
public class FakePriamInstanceFactory implements IPriamInstanceFactory {
	...
	@Override
	public PriamInstance create(String app, int id, String instanceID,
			String hostname, String ip, String zone,
			Map<String, PriamStorageDevice> volumes, String payload) {
	...
	@Override
	public void attachVolumes(PriamInstance instance, String mountPath,
			String device) {
