...
public class TestSnapshotBackupJob {
	...
	@Test
	public void testSnapshotList() throws BackupRestoreException, IOException,
			NoSuchAlgorithmException, DecoderException, InterruptedException {
	...
	@Test
	public void testSnapshotBackupJob() throws BackupRestoreException,
	...
	public static void createDirs(String snapshotName) throws IOException,
			InterruptedException {
		// Setup
		String[] dirs = {
				"cass/data/ks1/snapshots/1308981769779-" + snapshotName,
				"cass/data/ks1/snapshots/1308981710000-" + snapshotName,
				"cass/data/ks2/snapshots/1308981769779-" + snapshotName };
		String[] fileList = { dirs[0] + "/f1.db", dirs[1] + "/f2.db",
				dirs[2] + "/f1.db" };
